...
function CreateCatalog() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!title || !description || !category) {
            toast.error('Заполните все строки', { autoClose: 1500 });
            console.log('Please fill in all required fields.');
            return(
                <div>
                    <h1 className="mt-52">Заполгите все строки</h1>
                </div>
            );
        }
        ...
        try {
            ...
            const response = await axios.post('http://localhost:5000/api/collections', collectionData, {
                headers: {
                    'x-auth-token': token,
                },
            });
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="relative cursor-pointer">
                            ...
                            <div className="absolute right-[-50px] top-5">
                                <span title="Добавляет вашим айтемам доп. поле с возможностью ввести небольшой текст" className="material-symbols-outlined">
                                    info
                                </span>
                        ...
                        <div className="relative cursor-pointer">
                            ...
                            />
                            <div className="absolute right-[-50px] top-5">
                                <span title="Добавляет вашим айтемам доп. поле с возможностью  ввести числовую информацию" className="material-symbols-outlined">
                                    info
                                </span>
                                <span onClick={addNumbers} className="material-symbols-outlined">
                                    add
                                </span>
                            </div>
                            <div className="mt-3">
                                {userNumbers.slice(0, 3).map((number, index) => (
                                    <div key={index} className="flex justify-between items-center">
                                        {number}
                        ...
                        <div className="relative cursor-pointer">
                            ...
                            />
                            <div className="absolute right-[-50px] top-5">
                                <span title="Добавляет вашим айтемам доп. поле с возможностью ввести большой текст" className="material-symbols-outlined">
                                    info
                                </span>
                                <span onClick={addBig} className="material-symbols-outlined">
                                    add
                                </span>
                            </div>
                            <div className="mt-3">
                        ...
                        <div className="relative cursor-pointer">
                            ...
                            />
                            <div className="absolute right-[-50px] top-5">
                                <span title="Добавляет вашим айтемам доп. поле с возможностью указать два варианта да или нет" className="material-symbols-outlined">
                                    info
                                </span>
                                <span onClick={addBool} className="material-symbols-outlined">
                                    add
                                </span>
                            </div>
                            <div className="mt-3">
                        ...
                        <div className="relative cursor-pointer">
                            ...
                            />
                            <div className="absolute right-[-50px] top-5">
                                <span title="Добавляет вашим айтемам доп. поле с возможностью указать дату" className="material-symbols-outlined">
                                    info
                                </span>
                                <span onClick={addDate} className="material-symbols-outlined">
                                    add
                                </span>
                            </div>
                            <div className="mt-3">
